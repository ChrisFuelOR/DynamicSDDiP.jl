...
function generate_demand_distribution(tree_seed::Int, number_of_stages::Int, number_of_realizations::Int)
    ...
    distribution_list = [
        ...
        Distributions.LogNormal(0.12, 0.4),
        Distributions.LogNormal(0.1, 0.4),
        Distributions.LogNormal(0.08, 0.3),
        Distributions.LogNormal(0.07, 0.3),
        Distributions.LogNormal(0.15, 0.3),
        Distributions.LogNormal(0.11, 0.4),
        Distributions.LogNormal(0.13, 0.4),
        Distributions.LogNormal(0.10, 0.3),
        Distributions.LogNormal(0.14, 0.3),
        Distributions.LogNormal(0.08, 0.35),
        Distributions.LogNormal(0.07, 0.27),
        Distributions.LogNormal(0.1, 0.29),
        Distributions.LogNormal(0.12, 0.31),
        Distributions.LogNormal(0.18, 0.33),
        Distributions.LogNormal(0.14, 0.4),
        Distributions.LogNormal(0.15, 0.45),
        Distributions.LogNormal(0.08, 0.3),
    ]
    ...
    CSV.write("clsp_scenarios_larger.csv", df)

end

generate_demand_distribution(45678, 20, 20)
