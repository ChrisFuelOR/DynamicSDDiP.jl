...
function algo_config(
    ...
    stopping_rules = [SDDP.TimeLimit(time_limit), SDDP.BoundStalling(20,1e-4), SDDP.IterationLimit(3)]
    ...
    dual_solution_regime = DynamicSDDiP.Kelley(use_subopt_sol=false)
