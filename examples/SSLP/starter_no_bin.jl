...
function model_starter_runs()
    ...
    model_starter(6,50,40,200,:uni_lag, DynamicSDDiP.Core_Midpoint(integer_relax=true,normalize_direction=false), DynamicSDDiP.MultiCutRegime(), DynamicSDDiP.NoCutSelection(), "C:/Users/cg4102/Documents/julia_logs/SSLP_50_40_200_Mid.log", 10800, 11111, 12345)
    ...
    model_starter(8,50,40,200,:uni_lag, DynamicSDDiP.Core_Epsilon(perturb=1e-2,integer_relax=true,normalize_direction=false), DynamicSDDiP.MultiCutRegime(), DynamicSDDiP.NoCutSelection(), "C:/Users/cg4102/Documents/julia_logs/SSLP_50_40_200_Eps.log", 10800, 11111, 12345)
