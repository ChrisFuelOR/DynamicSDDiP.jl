...
function model_config(
    ...
    dual_space_regime = DynamicSDDiP.BendersSpanSpaceRestriction(10, :Benders)
    ...
    elseif duality_regime_sym == :lag
        duality_regime_1 = DynamicSDDiP.LagrangianDuality(
            atol = 1e-4,
            rtol = 1e-4,
            iteration_limit = 1000,
            dual_initialization_regime = dual_initialization_regime,
...
function model_starter_server()
    ...
    model_starter_single(3,:uni_lag, DynamicSDDiP.ChenLuedtke(), DynamicSDDiP.MultiCutRegime(), DynamicSDDiP.NoCutSelection(), "C:/Users/cg4102/Documents/julia_logs/sldp_binary_cl.log", 3600, 11111)
