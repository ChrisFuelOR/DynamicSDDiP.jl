...
function model_starter_runs()
    ...
    model_starter(13,100,20,:uni_lag, DynamicSDDiP.Core_Midpoint(integer_relax=false,normalize_direction=false), DynamicSDDiP.MultiCutRegime(), DynamicSDDiP.NoCutSelection(), "C:/Users/cg4102/Documents/julia_logs/CFLP_New_Mid_SB_NoNorm.log", 14400, 11111, 12345)
